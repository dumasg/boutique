    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                ...
                <?php }else{ ?>
                    <button onclick="window.location.href='?action=login'" class="btn btn-primary me-3" type="submit">Connexion</button>
                    <button onclick="window.location.href='?action=signup'" class="btn btn-primary me-3" type="submit">Inscription</button>
